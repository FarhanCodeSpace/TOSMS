      ...
      {isLoading ? (
        ...
        >
            ...
            <View style={styles.headerTop}>
              ...
              >
                {currentUser?.profileImageUrl ? (
                  ...
                  <Avatar.Text
                    size={44}
                    label={currentUser?.fullName?.[0] || "U"}
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statsCol}>
              <Text style={styles.statsValue} numberOfLines={1}>
                {currentUser?.pickupStop
                  ? currentUser.pickupStop.split(" ")[0]
                  : "—"}
              </Text>
          ...
          >
              ...
              >
                <View style={styles.miniCardHeader}>
                  <MaterialCommunityIcons
                    ...
                    color="#F59E0B"
                  />
                  <Text style={[styles.miniCardTitle, { color: "#92400E" }]}>
                    Availability
                  </Text>
                </View>
              ...
              >
                <View style={styles.miniCardHeader}>
                  <MaterialCommunityIcons
                    ...
                    color="#16A34A"
                  />
                  <Text style={[styles.miniCardTitle, { color: "#16A34A" }]}>
                    Availability
                  </Text>
                </View>
                <View style={styles.miniCardStatusRow}>
                  <MaterialCommunityIcons
                    ...
                    color="#16A34A"
                  />
                  <Text style={[styles.miniCardStatus, { color: "#16A34A" }]}>
                    Available
                  </Text>
                </View>
              ...
              >
                <View style={styles.miniCardHeader}>
                  <MaterialCommunityIcons
                    ...
                    color="#DC2626"
                  />
                  <Text style={[styles.miniCardTitle, { color: "#DC2626" }]}>
                    Availability
                  </Text>
                </View>
                <Text
            ...
            {/* My Route Mini Card */}
            <TouchableOpacity
              style={[styles.miniCard, styles.whiteMiniCard]}
              onPress={() => navigation.navigate("MyRouteTab" as any)}
            >
              <View style={styles.miniCardHeader}>
                <MaterialCommunityIcons
                ...
                />
                <Text style={[styles.miniCardTitle, { color: COLORS.primary }]}>
                  My Route
                </Text>
              </View>
                  ...
                  <View
                    ...
                    style={[
                      styles.dayChip,
                      {
                        ...
                        borderWidth: statusColor === "#E5E7EB" ? 1 : 1.5,
                      },
                    ]}
                  >
            ...
            <View style={styles.todayCardWrapper}>
              {!todayRide ? (
                <View style={styles.noRideCard}>
                  ...
                  <Text style={styles.noRideSub}>
                    Your driver hasn't scheduled a ride yet
                  </Text>
                </View>
                ...
                <View style={styles.rideStateCard}>
                  ...
                  <View style={styles.rideTopRow}>
                    ...
                    >
                      <Text
                        style={[styles.rideStatusText, { color: "#92400E" }]}
                      >
                        Scheduled
                      </Text>
                    </View>
                ...
                <View style={styles.rideStateCard}>
                  ...
                  />
                  <View style={styles.rideTopRow}>
                    <Text style={[styles.rideCardTitle, { color: "#6B7280" }]}>
                      {todayRide.routeName}
                    </Text>
                    <View
                      style={[
                    ...
                    >
                      <Text
                        style={[styles.rideStatusText, { color: "#6B7280" }]}
                      >
                        Completed
                      </Text>
                    </View>
                  ...
                  <View style={styles.rideMiddleRow}>
                    ...
                    <View style={styles.rideInfoItem}>
                      ...
                      <Text style={styles.rideInfoText}>
                        {todayRide.date
                          ? format(new Date(todayRide.date), "MMM d, yyyy")
